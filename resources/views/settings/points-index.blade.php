                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        ...
                                                        <button type="button" class="btn btn-outline-secondary btn-sm waves-effect waves-light" data-toggle="modal"
                                                            data-target="#points-update-{{ $point->id }}"><i class="mdi mdi-pencil"></i></button>

                                                        <!-- sample modal content -->
                                                        <div id="points-update-{{ $point->id }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title mt-0" id="myModalLabel">{{ $point->event }}</h5>
                                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                            <span aria-hidden="true">&times;</span>
                                                                        </button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <form class="custom-validation" method="post" action="{{ route('points.update', $point->id) }}" enctype="multipart/form-data">
                                                                            @csrf @method('patch')
                                                                            <div class="row">
                                                                                <div class="col-md-6 mb-3">
                                                                                    <label for="validationCustom01">Min Points</label>
                                                                                    <input name="min" type="number" class="form-control" id="validationCustom01" placeholder="Min Points" value="{{ $point->min }}" required="">
                                                                                ...
                                                                                <div class="col-md-6 mb-3">
                                                                                    ...
                                                                                    <input name="max" type="number" class="form-control" id="validationCustom02" placeholder="Max Points" value="{{ $point->max }}" required="">
                                                                                    <div class="valid-feedback">
                                                                                        Looks good!
                                                                                    </div>
                                                                                </div>
